...
<body>
	...
	<section>
		...
		<form method="post" action="/update/{{ $student->id }}">
			...
			Student Number <br>
			<input type="text" name="studNumber" value="{{ $student->studNumber }}"> <br>
			Name <br>
			<input type="text" name="studName" value="{{ $student->studName }}"> <br>
			Course <br>
			<input type="text" name="course" value="{{ $student->course }}"> <br>
			Year <br>
			<input type="number" name="year" min="1" max="5" value="{{ $student->year }}"> <br>
			Address <br>
			<textarea name="address" rows="5" cols="50" style="text-align:left !important">{{ $student->address }}</textarea>
